...
export function calculateShipping(weight, country, orderTotal) {
  ...
  var total = 0;
  if(country === "US" && weight <= 1) total = 5;
  else if(country === "US" && weight <= 5) total = 10;
  else if(country === "US" && weight > 5) total = 15;
  else if(country !== "US" && weight <= 1) total = 15;
  else if(country !== "US" && weight <= 5) total = 25;
  else total = 40;
