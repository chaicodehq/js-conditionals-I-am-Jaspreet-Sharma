...
export function calculateTax(income) {
  ...
  var tax = 0;
  if(income > 0 && income <= 10000) tax = 0;
  else if(income > 10000 && income <= 30000) tax = 0 + (income - 10000) * 0.1;
  else if(income > 30000 && income <= 70000) tax = 0 + 2000 + (income - 30000) * 0.2;
  else tax = 0 + 2000 + 8000 + (income - 70000) * 0.3;
  return tax;
}
